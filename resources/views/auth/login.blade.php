        ...
        <div class="hidden lg:flex lg:flex-col lg:w-[480px] xl:w-[560px] flex-shrink-0 relative overflow-hidden p-12"
            ...
            <div class="relative z-10 flex flex-col h-full">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p style="font-size:22px; font-weight:700; color:#FFFFFF; line-height:1.1;">SmartStock Pro</p>
                        <p style="font-size:13px; color:rgba(255,255,255,0.9); line-height:1.3;">PT Maju Bersama Digital</p>
                    </div>
                </div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-sm">
                ...
                <div class="flex items-center gap-2.5 mb-8 lg:hidden">
                    ...
                    <div>
                        <p style="font-size:19px; font-weight:700; color:#061B31; line-height:1.1;">SmartStock Pro</p>
                        <p style="font-size:12px; color:#64748D; line-height:1.3;">PT Maju Bersama Digital</p>
                    </div>
                </div>
