...
<head>
    ...
    <title>500 Kesalahan Server — SmartStock Pro</title>
...
<body class="h-full" style="background-color:#F8FAFC; font-family:'Inter',sans-serif; display:flex; align-items:center; justify-content:center; padding:24px;">
    <div style="text-align:center; max-width:400px;">
        ...
        <p style="font-size:64px; font-weight:300; color:#EF4444; line-height:1; margin-bottom:16px;">500</p>
        <h1 style="font-size:26px; font-weight:300; color:#061B31; margin-bottom:8px;">Kesalahan Server</h1>
        <p style="font-size:14px; color:#64748D; line-height:1.6; margin-bottom:32px;">Terjadi kesalahan internal. Tim teknis telah diberitahu secara otomatis dan sedang menangani masalah ini.</p>
